...
export default function ServicoPorOrcamentoPage() {
  ...
  return (
    <div className="orcamento-especifico-user">
      {servicosAndamento.length === 0 && servicosDevolvidos.length === 0 ? (
        <div className="message-finalizado">
          <p>O orçamento fora finalizado!</p>
          <p>Por gentileza, visitar a página de pedido para que possa acompanhar seu orçamento!</p>
        </div>
      ) : (
        <div>
              ...
              servicosAndamento.map((servico) => (
                <div className="servico" key={servico.id}>
                  ...
                  <div className="body-servico-orcamento">
                    ...
                    <p>
                      <span className="strong">Largura:</span> {servico.largura}{" "}
                      cm
                    </p>
                    <p>
                      <span className="strong">Altura:</span> {servico.altura}{" "}
                      cm
                    </p>
                    <p>
                      <span className="strong">Fechadura:</span>{" "}
                      {servico.fechadura}
                    </p>
                    <p>
